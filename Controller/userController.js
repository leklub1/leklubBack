...
export const createNewUser = async (req, res) => {
    ...
    try {
        ...
        // if (statementPayment.success && statementSubscription.success) {
            const { paymentId, paymentUrl } = await createMonthlySubscription(result.userId, 'https://287c-2a02-842a-14c-3601-5cef-642f-8515-36ac.ngrok-free.app/api/payment/webhook');
